...
class Solution126_dfs {
    ...
    public List<List<String>> findLadders(String beginWord, String endWord, List<String> wordList) {
        ...
        temp.add(beginWord);
        dfs(res, temp, beginWord, endWord);
        return res;
    }
        ...
        while (!queue.isEmpty()) {
            ...
            while (size-- > 0) {
                ...
                if (!map.containsKey(s)) {
                    Set<String> ns = neighbours(s, wordList);
                    map.put(s, ns);
                }
                Set<String> neighbours = map.get(s);
    ...
    private Set<String> neighbours(String begin, List<String> wordList) {
        Set<String> set = new HashSet<>();
        for (String word : wordList) {
            if (!word.equals(begin) && canConvert(begin, word)) {
                set.add(word);
            }
        }
        return set;
    ...
    private void dfs(List<List<String>> res, List<String> temp, String cur, String endWord) {
